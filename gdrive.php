...
if($argc === 3){
	...
	try {
			...
			$client->setRedirectUri('https://hotstardl.herokuapp.com/redirect.php');
			...
			if($result == true) {
				...
				echo "Error occurred in uploading file to drive".PHP_EOL;
			}
			
	} catch(Exception $e) {
		$client->revokeToken();
		echo "Error occurred. Error Message : ".$e->getMessage().PHP_EOL;
	}
